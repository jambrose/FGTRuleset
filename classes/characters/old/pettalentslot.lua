	...
	if not updating then
		...
		if sourcenode then
			...
			if slottype ~= "" and classnode and recordnamenode then
				...
				if recordnamevalue ~= "" and classvalue ~="" and (string.lower(classvalue) == string.lower(slottype) or string.lower(classvalue) == "disease" or string.lower(classvalue) == "insanity" or string.lower(classvalue) == "invention") then
...
function getSlotNode()
	return window.getDatabaseNode().getChild("sockets." .. slotnumbervalue);
end
				...
				if rechargecontrol then
					if rechargecontrol.getDatabaseNode().getValue() == 0 then
						if draginfo.getType() == "shortcut" then			
							...
							if string.lower(class) == string.lower(slottype) or string.lower(class) == "disease" or string.lower(class) == "insanity" or string.lower(class) == "invention" then
